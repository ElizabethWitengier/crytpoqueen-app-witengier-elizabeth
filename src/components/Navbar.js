...
const Navbar = () => {
  ...
  const activeClass =
    "block py-2 pl-3 pr-4 text-white bg-gold rounded md:bg-transparent md:text-gold md:p-0 md:dark:text-gold";
  const unActiveClass =
    "block py-2 pl-3 pr-4 text-blue rounded hover:bg-text-gold md:hover:bg-transparent md:hover:text-gold md:p-0 md:dark:hover:text-gold dark:text-blue dark:hover:bg-transparent dark:hover:text-gold md:dark:hover:bg-transparent";
